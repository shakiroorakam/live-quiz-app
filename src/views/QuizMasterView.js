        ...
        <div className='modal-content'>
          <div className='modal-header'>
            <h5 className='modal-title'>
              Answer History for {participant.name}
            </h5>
                    ...
                    <div className='input-group-prepend'>
                      <div className='input-group-text'>
                        <input
                          type='radio'
                          name='correctAnswer'
                          checked={editedQuestion.correctAnswer === String(i)}
                          onChange={() =>
                            setEditedQuestion({
                              ...editedQuestion,
            ...
            <div className='row'>
              ...
              <div className='col'>
                ...
                <input
                  type='number'
                  className='form-control'
                  value={editedQuestion.negativePoints || 0}
                  onChange={(e) =>
                    setEditedQuestion({
                      ...editedQuestion,
      ...
      {!answer.verified && (
        <div className='d-flex align-items-center'>
          ...
          <button
            ...
            title='Mark as Correct with this score'
  ...
  return (
    <div className='row'>
      <div className='col-lg-4 mb-4 mb-lg-0'>
                ...
                <div className='input-group-prepend'>
                  <div className='input-group-text'>
                    <input
                      type='radio'
                      name='correctAnswer'
                      checked={newQuestion.correctAnswer === String(i)}
                      onChange={() =>
                        setNewQuestion({
                          ...newQuestion,
                          correctAnswer: String(i),
        ...
        <button
          className='btn btn-primary btn-block animated-button mt-3'
...
const StartQuizTab = ({ quiz, handleAirQuestion, airedQuestionIds }) => (
  <div>
    ...
    <p className='text-muted'>
      Select a question from the bank to send it to the participants' screens.
      Aired questions will be disabled.
    </p>
    <div className='list-group'>
      {quiz.questions?.length > 0 ? (
        ...
        <p className='text-muted'>
          No questions in the bank. Add some in the 'Questions' tab.
        </p>
      )}
    </div>
  </div>
...
export function QuizMasterView({ user }) {
  ...
  const handleVerificationScoreChange = (participantId, score) => {
    setVerificationScores((prev) => ({
      ...prev,
      [participantId]: parseInt(score, 10),
    }));
  };
    ...
    if (
      ...
      return (
        <div className='live-question-indicator p-4 rounded'>
          ...
          <p>
            {participantResponses.length} of {participants.length} responded.
          </p>

          {quiz.state === "question_live" && (
            <button className='btn btn-warning' onClick={handleRevealAnswer}>
              Reveal Answer
            </button>
          )}
          {quiz.state === "question_ended" && (
            <div>
                    ...
                    return (
                      p && (
                        <VerificationListItem
                          ...
                          currentScore={
                            verificationScores[ans.id] ?? currentQuestion.points
                          }
              ...
              {!allVerified && participantResponses.length > 0 && (
                <small className='d-block text-muted mt-2'>
                  You must verify all answers before proceeding.
                </small>
              )}
            </div>
          )}
          {quiz.state === "scorecard_display" && (
    ...
    switch (activeTab) {
      ...
      case "startQuiz":
        return (
          <StartQuizTab
            quiz={quiz}
            handleAirQuestion={handleAirQuestion}
            airedQuestionIds={airedQuestionIds}
          />
        );
      case "participants":
        return (
  ...
  return (
    <>
      <div
        className='animated-card text-dark p-3 p-md-4 mx-auto'
        style={{ width: "90%", maxWidth: "1200px" }}
      >
        <div className='d-flex justify-content-between align-items-center mb-3 flex-wrap'>
          <div>
            <h2 className='mb-1 text-primary font-weight-bold'>
              {quiz?.title || "Quiz"}
            </h2>
            {quiz.state === "lobby" && (
              <button
            ...
            {quiz.state !== "lobby" && quiz.state !== "finished" && (
              <button className='btn btn-danger btn-sm' onClick={handleEndQuiz}>
                <StopCircle size={16} className='mr-2' /> End Quiz
              </button>
            )}
          </div>
          <div>
