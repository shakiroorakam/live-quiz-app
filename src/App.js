    ...
    return (
        <HashRouter>
            <div className="app-background-dark">
                <Navbar user={user} />
                <div className="container d-flex justify-content-center align-items-center" style={{ minHeight: 'calc(100vh - 56px)', padding: '20px 0' }}>
                    <Routes>
                        ...
                        {/* This is the corrected line. We now pass the user prop. */}
